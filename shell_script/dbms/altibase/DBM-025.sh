#!/bin/bash
# shell_script/dbms/altibase/DBM-025.sh
# [DBM-025] Audit Table에 대한 접근 제어 미흡 – altibase
...
if [[ -n "$MISSING" ]]; then
    ...
    echo "EVIDENCE=input/evidence/dbms/altibase/audit_table_privileges.txt 필요"
    exit 0
fi
